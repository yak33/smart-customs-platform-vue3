...
const model = defineModel<Api.GoodsManage.ProductSearchParams>('model', { required: true });
      ...
      <NGrid responsive="screen" item-responsive :x-gap="8" :y-gap="8" cols="1 s:1 m:5 l:5 xl:5 2xl:5">
        <NGridItem span="4">
          <NGrid responsive="screen" item-responsive :x-gap="8">
            <NFormItemGi span="24 s:8 m:6" :label="$t('page.goods.product.productName')" path="productName">
              <NInput v-model:value="model.productName" size="small" :placeholder="$t('page.goods.product.form.productName')" />
            </NFormItemGi>
          </NGrid>
        </NGridItem>
        <NGridItem>
