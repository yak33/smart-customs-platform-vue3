...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    ...
    children: [
      {
        name: 'goods_goods-list',
        path: '/goods/goods-list',
        component: 'view.goods_goods-list',
        meta: {
          title: 'goods_goods-list',
          i18nKey: 'route.goods_goods-list'
        }
      },
      {
        name: 'goods_goods-set',
        path: '/goods/goods-set',
        component: 'view.goods_goods-set',
        meta: {
          title: 'goods_goods-set',
          i18nKey: 'route.goods_goods-set'
        }
      }
    ]
  },
